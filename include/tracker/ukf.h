...
public:
  ...
  //* Sigma point spreading parameter //UKF
  double lambda_;
  ...
  bool is_stable_;
  perception_ros::DetectedObject object_;
  std::string label_;
  ...
  void updateMeasurementForCTRV(const std::vector<perception_ros::DetectedObject>& object_vec);

  void uppateForCTRV();

  void updateEachMotion(const double detection_probability, const double gate_probability, const double gating_threshold,
                        const std::vector<perception_ros::DetectedObject>& object_vec, std::vector<double>& lambda_vec);

  void updateSUKF(const std::vector<perception_ros::DetectedObject>& object_vec);
  ...
  void checkLaneDirectionAvailability(const perception_ros::DetectedObject& in_object,
  ...
  double calculateNIS(const perception_ros::DetectedObject& in_object, const int motion_ind);

  bool isLaneDirectionAvailable(const perception_ros::DetectedObject& in_object, const int motion_ind,
  ...
  void update(const bool use_sukf, const double detection_probability, const double gate_probability,
              const double gating_threshold, const std::vector<perception_ros::DetectedObject>& object_vec);
