...
if(NOT "/home/chenwei/perception_ros/include " STREQUAL " ")
  set(perception_ros_INCLUDE_DIRS "")
  set(_include_dirs "/home/chenwei/perception_ros/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chenwei/perception_ros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chenwei/perception_ros/cmake-build-debug/devel/lib;/opt/ros/kinetic/lib)
